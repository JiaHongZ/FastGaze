...
def main(args):
    ...
    if retraining:
        ...
        model_dir = join('train_' + str(args.net_name)+str(args.num_encoder)+'E_'+str(args.num_decoder)+'D_'+str(args.batch_size)+'_'+str(args.hidden_dim)+'_'+str(args.sc_ior)+'_'+str(args.sc_mask)+'_' + timenow)
    ...
    if retraining:
        ...
        for p in model.vs.lip.parameters():
    ...
    for epoch in range(start_epoch, args.epochs+1):
        ...
        output_str2 = f"Epoch: {epoch}, best_epo: {best_epo}, bestss: {best_seq:.3f}, seq_score: {seq_score:.3f}, seq_score_t: {seq_score_t:.3f}, sem_seq_score: {sem_seq_score:.3f}, sem_seq_score_t: {sem_seq_score_t:.3f}, ed: {ed:.3f}, ed_t: {ed_t:.3f}, sem_ed: {sem_ed:.3f}, sem_ed_t: {sem_ed_t:.3f}\n"
