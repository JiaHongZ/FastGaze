...
def get_args_parser_test():
    ...
    parser.add_argument('--condition', default='absent', type=str, help="Search condition (present/absent)")
    ...
    parser.add_argument('--img_ior', default=False, type=bool, help="Use IOR")
    parser.add_argument('--img_mask', default=False, type=bool, help="Use Mask")
    parser.add_argument('--txt_ior', default=False, type=bool, help="Use IOR")
    parser.add_argument('--txt_mask', default=False, type=bool, help="Use Mask")
    parser.add_argument('--sc_ior', default=False, type=bool, help="Use IOR")
    parser.add_argument('--sc_mask', default=False, type=bool, help="Use Mask")
    return parser
...
def get_args_parser_train():
    ...
    parser.add_argument('--sc_ior', default=False, type=bool, help="Use IOR")
    parser.add_argument('--sc_mask', default=False, type=bool, help="Use Mask")
    parser.add_argument('--net_name', default='fastgaze', type=str, help="Use Mask")
    parser.add_argument('--condition', default='absent', type=str, help="Search condition (present/absent)")
